...
urlpatterns = [
    ...
    path("api/administrator_service/doctors/list/",
         views.DoctorView.as_view(), name="doctor_list"),
    path("api/administrator_service/doctors/setData/",
         views.DoctorView.as_view(), name="doctor_setdata"),
    path("api/administrator_service/doctors/removeAvatar/",
         views.DoctorView.as_view()),
    path("api/administrator_service/doctors/delete/",
         views.DoctorView.as_view(), name="doctor_delete"),
    ...
    path("api/administrator_service/medicine/list/",
         views.MedicineView.as_view(), name="medicine_list"),
    path("api/administrator_service/medicine/delete/",
         views.MedicineView.as_view(), name="medicine_delete"),
    ...
    path("api/administrator_service/medicine/setData/",
         views.MedicineView.as_view(), name="medicine_setdata"),
