...
SECRET_KEY = "django-insecure-uj)j#b+4(yxno$@i6e7(pe1rzvig^qn943+ruz$ra!p5n$6%@f"
...
DATABASE_ROUTERS = ['path.to.db_router.AdministratorDBRouter', 'path.to.db_router.DoctorDBRouter']
